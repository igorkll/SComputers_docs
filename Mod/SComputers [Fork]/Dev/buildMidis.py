...
# Копируем файлы из папки midis в папку importer/files
shutil.copytree("midis", "../USER/importer/files")
...
# Копируем файл disk.json из importer в gamedisks и переименовываем в midis.json
shutil.copyfile("../USER/importer/disk.json", "../gamedisks/midis.json")
